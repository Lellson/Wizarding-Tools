package lellson.wizardingtools.entity.render;
...
public class renderAxe extends Render
{
    ...
    public renderAxe(Item p_i1259_1_, int p_i1259_2_)
    {
        this.field_94151_a = p_i1259_1_;
        this.field_94150_f = p_i1259_2_;
    }

    public renderAxe(Item p_i1260_1_)
    {
        this(p_i1260_1_, 0);
    }
