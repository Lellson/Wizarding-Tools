...
public class ItemEnhancedTitaniumLeggings extends ItemArmor {

	public ItemEnhancedTitaniumLeggings(ArmorMaterial material, int texture, int armorType) {
	...
	public void onUpdate(ItemStack item, World world, Entity entity, int i, boolean b)
    {
		if (!world.isRemote) {
			if (!item.isItemEnchanted()) {
				...
				item.addEnchantment(Enchantment.blastProtection, 4);
			}
		}
	}
